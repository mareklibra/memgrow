...
export const ChooseCourse = ({ courses, pathPrefix }: { courses: CourseType[]; pathPrefix: string }) => {
    return (<ul className="max-w-md divide-y divide-gray-200 dark:divide-gray-700">
        {courses.map((course) => <Course course={course} key={course.id} pathPrefix={pathPrefix} />)}
    </ul>
    );
}